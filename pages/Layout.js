...
export default function Layout({ children }) {
  ...
  <span className="text-2xl text-white">ffice</span> */}
            ...
            <div className="text-xs text-center bg-sky-600 px-1 opacity-95">
...
*/}
	...
	<path transform="scale(0.3,0.3)" d="M272.132,108.323l4.615-4.616c3.932-3.932,3.932-10.307,0-14.238c-3.933-3.931-10.306-3.931-14.238,0l-4.73,4.731
	...
	<path transform="scale(0.3,0.3)" d="M113.89,175.872h69.219c5.56,0,10.067-4.508,10.067-10.068c0-5.56-4.508-10.067-10.067-10.067H113.89
		c-5.56,0-10.067,4.508-10.067,10.067C103.822,171.364,108.33,175.872,113.89,175.872z"/>
	<path  transform="scale(0.3,0.3)" d="M61.979,193.176c15.093,0,27.372-12.279,27.372-27.372c0-15.093-12.279-27.371-27.372-27.371s-27.371,12.278-27.371,27.371
	...
	<path transform="scale(0.3,0.3)" d="M235.02,193.176c15.093,0,27.371-12.279,27.371-27.372c0-15.093-12.278-27.371-27.371-27.371
      ...
      <section className="bg-white border-b py-8">
        <div className="container mx-auto flex flex-wrap pt-4 pb-12">
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-gradient-to-r from-gray-100 to-transparent rounded-t rounded-b-none overflow-hidden shadow">
              <a
                href="#"
                className="flex flex-wrap no-underline hover:no-underline"
              >
            ...
            <div className="flex-none mt-auto bg-gradient-to-r from-gray-100 to-transparent rounded-b rounded-t-none overflow-hidden shadow p-6">
              <div className="flex items-center justify-center">
                <button className="mx-auto lg:mx-0 hover:underline gradient text-gray font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                  Action
                </button>
