...
*/}
      ...
      <section className="bg-white border-b py-8">
            ...
            <div className="w-32 h-32 sm:w-1/2 p-6 ">
              ...
              >
                ...
                <path
                  ...
                  d="M272.132,108.323l4.615-4.616c3.932-3.932,3.932-10.307,0-14.238c-3.933-3.931-10.306-3.931-14.238,0l-4.73,4.731
		...
		c2.332,0,4.621-0.185,6.858-0.533V236.216z"
                ...
                <path
                  transform="scale(0.3,0.3)"
                  d="M113.89,175.872h69.219c5.56,0,10.067-4.508,10.067-10.068c0-5.56-4.508-10.067-10.067-10.067H113.89
		c-5.56,0-10.067,4.508-10.067,10.067C103.822,171.364,108.33,175.872,113.89,175.872z"
                />
                <path
                  transform="scale(0.3,0.3)"
                  d="M61.979,193.176c15.093,0,27.372-12.279,27.372-27.372c0-15.093-12.279-27.371-27.372-27.371s-27.371,12.278-27.371,27.371
		...
		c-3.989,0-7.236-3.246-7.236-7.236C54.742,161.814,57.989,158.567,61.979,158.567z"
                ...
                <path
                  transform="scale(0.3,0.3)"
                  d="M235.02,193.176c15.093,0,27.371-12.279,27.371-27.372c0-15.093-12.278-27.371-27.371-27.371
