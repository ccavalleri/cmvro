import { SearchIcon, AdjustmentsVerticalIcon } from '@heroicons/react/24/solid';
    ...
    <header className="py-3 lg:py-0 bg-white shadow-md mdk-header--fixed">
      <div className="lg:pl-4 px-8 flex flex-wrap items-center">
        <div className="items-center">
          <a
            href="/"
            className="flex items-center text-xl w-sidebar mr-4 hover:no-underline"
          >
        ...
        <div className="flex-1 flex justify-between">
          <div className="relative text-gray-darker hidden lg:flex flex-grow">
            <div className="flex w-full mt-2 mb-2 mx-auto max-w-[90%] border border-gray-200 hover:shadow-lg focus-within:shadow-lg px-2 py-3 rounded-full items-center sm:max-w-xl lg:max-w-2xl">
        ...
        <div className="lg:flex lg:items-center lg:w-auto w-full" id="menu">
          <ul className="lg:flex items-center justify-between text-md text-gray-900 font-semibold pt-4 lg:pt-0">
            ...
            <li>
              <a className="btn btn-success" href="login.html">
                Login
              </a>
            </li>
          </ul>
